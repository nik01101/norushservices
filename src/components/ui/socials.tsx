    ...
    return (
        <div className="w-full py-12 md:py-24 lg:py-32 flex flex-col items-center justify-center bg-[--background] relative overflow-hidden">
             <div className="relative z-10 space-y-4 text-center mb-12 px-4">
                <h2 className="text-4xl sm:text-5xl text-[#402D29]">Follow Us</h2>
                <p className="max-w-[900px] mx-auto text-accent-foreground md:text-xl/relaxed">
                    Check out our latest projects and updates on social media.
                </p>
            </div>

            <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6 px-4 w-full max-w-6xl">
