...
export function SocialMedia1() {
    ...
    return (
        <div className="relative w-full py-12 md:py-24 lg:py-32 overflow-hidden flex flex-col items-center justify-center bg-[white]">
            ...
            <div className="absolute w-64 h-64 bg-white/20 rounded-full bottom-10 right-10 blur-3xl animate-blob animation-delay-2000"></div>
             ...
             <div className="space-y-4 text-center mb-12">
                <h2 className="text-4xl sm:text-5xl">Follow Us 1</h2>
